        ...
        <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
          ...
          <div className="@container">
            <div className="@[480px]:p-4">       
              <div className="relative flex min-h-[480px] flex-col gap-6 bg-cover bg-center bg-no-repeat @[480px]:gap-8 @[480px]:rounded-xl items-center justify-center p-4 overflow-hidden">
                <div className="absolute inset-0 z-0 bg-cover bg-center bg-no-repeat filter blur-sm" style={{ backgroundImage: 'linear-gradient(rgba(0, 0, 0, 0.1) 0%, rgba(0, 0, 0, 0.4) 100%), url(https://wallpapers.com/images/hd/walmart-aesthetic-shot-rkr68kyciqagp180.jpg)' }} />
                <div className="relative z-10 flex flex-col gap-2 text-center">
                  <h1 className="text-[#ffc220] text-4xl font-black leading-tight tracking-[-0.02em] @[480px]:text-5xl">
                    Discover Your Style with ShopSwipe
                  </h1>
                  <h2 className="text-white text-m font-bold leading-normal @[480px]:text-base">
                    Swipe right on items you love, and we'll curate a personalized shopping experience just for you.
                  </h2>
                </div>
                <Link to="/swipe" className="relative z-10">
                  <button className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-full h-10 px-6 @[480px]:h-12 @[480px]:px-9 bg-[#ffc220] text-black hover:bg-[#c59d30] transition-all duration-300 text-m font-bold leading-normal tracking-[0.015em] @[480px]:text-base">
        ...
        <div className="flex max-w-[960px] flex-1 flex-col">
          <footer className="flex flex-col gap-6 px-5 py-10 text-center @container">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <a href="https://x.com/Walmart" aria-label="Twitter">
              ...
              <a href="https://www.instagram.com/walmart/" aria-label="Instagram">
                <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="#637c88" viewBox="0 0 256 256">
                  <path d="M128,80a48,48,0,1,0,48,48A48.05,48.05,0,0,0,128,80Zm0,80a32,32,0,1,1,32-32A32,32,0,0,1,128,160ZM176,24H80A56.06,56.06,0,0,0,24,80v96a56.06,56.06,0,0,0,56,56h96a56.06,56.06,0,0,0,56-56V80A56.06,56.06,0,0,0,176,24Zm40,152a40,40,0,0,1-40,40H80a40,40,0,0,1-40-40V80A40,40,0,0,1,80,40h96a40,40,0,0,1,40,40ZM192,76a12,12,0,1,1-12-12A12,12,0,0,1,192,76Z" />
                </svg>
              </a>
              <a href="https://www.facebook.com/walmart/" aria-label="Facebook">
                <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="#637c88" viewBox="0 0 256 256">
